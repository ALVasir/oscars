    ...
    for anyodicc in diccionario["Ganadores"]:
        for anyo, categorias in anyodicc.items():
            if "Mejor Pelicula" in categorias:
                ...
                director_info = pelicula["Director"] if "Director" in pelicula else {}
                nacionalidad = director_info["Nacionalidad"] if "Nacionalidad" in director_info else ""
                ...
                if nacionalidad == "Reino Unido":
                    ...
                    info = {
                        'año': anyo,
                        'titulo': pelicula["Titulo"] if "Titulo" in pelicula else "Desconocido",
                        'director': director_info["Nombre"] if "Nombre" in director_info else "Desconocido",
                        'premios': premios
                    }
