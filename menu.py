...
with open('ganadores.json','r') as archivo:
...
# 4. Listar los Oscars de un actor/director. Ej: Stven Spielberg ganó x Oscars los años: 2020 con la peli X, 2021 con la peli X
...
{19*" "}Ranking según actor/director/película [5]
{51*" "}Salir [6]
{18*" "}{38*"-"}''')

# menú de opciones, que se ejecutan en funciones.py
